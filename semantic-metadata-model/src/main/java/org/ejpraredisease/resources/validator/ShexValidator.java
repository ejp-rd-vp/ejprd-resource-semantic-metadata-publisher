...
public class ShexValidator {
          public static void main(String[] args) throws Exception {
            Path schemaFile = Paths.get("/Users/dipo/Documents/GitHub/ejprd-resource-semantic-metadata-publisher/semantic-metadata-model/src/main/resources/datatypes.json"); //to change with what you want
            Path dataFile = Paths.get("/Users/dipo/Documents/GitHub/ejprd-resource-semantic-metadata-publisher/semantic-metadata-model/src/main/resources/datatypes-data.ttl"); //to change with what you want
