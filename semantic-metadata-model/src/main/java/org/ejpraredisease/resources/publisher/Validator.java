...
public class Validator {
    public static void main(String[] args) throws Exception {
        Path schemaFile = Paths.get("src", "main", "resources", "datatypes.json"); //to change latter
        Path dataFile = Paths.get("src", "main", "resources", "datatypes-data.ttl"); //to change latter
        ...
        IRI focusNode = factory.createIRI("http://a.example/boolean-true"); //to change latter
        Label shapeLabel = new Label(factory.createIRI("http://a.example/S-boolean")); //to change latter
